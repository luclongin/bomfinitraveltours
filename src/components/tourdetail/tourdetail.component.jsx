            ...
            <main>
                  ...
                  <Container className="tourdetail-content-container">
                        <Row className="tourdetail-content-container-row-programme tourdetail-content-container-row justify-content-md-center">  
                              ...
                              {typeof(specificTourContent.programme) == "undefined" ? <p className="sepeudesugerir"><span className="sepuedesugerir-asterisk">*</span> SE PUEDE SUGERIR CAMBIOS EN EL ITINERARIO</p> : ""}
                        </Row>
